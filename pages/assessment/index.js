...
Page({
    ...
    handleNum: function(num) {
        return Number(num).toFixed(0) // 返回一个字符串，去掉小数点后面小数，0位小数。例如num=12.1212 => 12
    },
    ...
    // 初始化当前的页面，传入通过list的navigation触发get跳转传递的参数，初始化所有渲染参数
    // 比如assessmentItem这个参数，它存储了调用api时会传递的参数。
